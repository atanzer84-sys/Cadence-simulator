...
def test_load_channel_config_invalid_int_raises_valueerror(tmp_path):
    ...
    write_cfg(cfg_path, channel_name="NIR", x_pixels="not_an_int")
...
def test_load_channel_config_invalid_float_raises_valueerror(tmp_path):
    ...
    write_cfg(cfg_path, channel_name="NIR", resolution_factor="not_a_float")
...
def test_load_channel_config_ignores_comments(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(_PSF_LOADER, fake_psf_image_loader)
...
def test_load_channels_config_calls_load_channel_config_three_times(monkeypatch, tmp_path):
    ...
    write_cfg(nuv_cfg, channel_name="NUV", effective_area_file="nuv.txt", x_pixels=2)
    write_cfg(vis_cfg, channel_name="VIS", effective_area_file="vis.txt", x_pixels=2)
    write_cfg(
        ir_cfg,
        channel_name="NIR",
        effective_area_file="ir.txt",
