...
Previously missing (now covered): dump_3d_array (needs get_global_config mocked).
Still missing: dump_1d_array (same config dependency; can be added with same mock pattern).
"""
import numpy as np
import pytest
