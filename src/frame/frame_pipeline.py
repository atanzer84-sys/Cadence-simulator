...
def generate_frames(nuv_images, vis_images, nir_images, nuv: SpectroscopyChannel, vis: SpectroscopyChannel, nir: PhotometryChannel, ctx: RunContext, star: Star):
    ...
    science_nir_frames = generate_science_frame(nir_images, nir, header)
