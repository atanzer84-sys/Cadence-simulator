...
class RunContext:
    ...
    plot_target_star_counts_vs_noise_spectroscopy: Callable[..., Any]
    plot_target_star_counts_vs_noise_photometry: Callable[..., Any]
    plot_background_star_counts: Callable[..., Any]
    write_calibration_frames_png: Callable[..., Any]
