...
def initialize_waltzer_runtime_context():
    ...
    logging.info("RunContext initialized: target=%s output_dir=%s write_intermediate_arrays=%s produce_plots=%s write_image_png=%s write_background_star_png=%s", run_ctx.target_name, run_ctx.output_dir, cfg.write_intermediate_arrays, cfg.produce_plots, cfg.write_calibration_frames_png, cfg.write_background_star_png)
