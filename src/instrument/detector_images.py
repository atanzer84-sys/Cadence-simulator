...
def generate_detector_images_and_write_fits(counts_s_pixel_convolved_nuv, counts_s_pixel_convolved_vis, nuv_cfg, vis_cfg, nuv_cal, vis_cal, user_cfg, output_dir, star):
...
def build_science_frames(counts_s_pixel_convolved, channel_cfg, channel_cal, n_frames, exposure_time_s, base_header):
