...
def main():
    try:
        ...
        rate_nir = prepare_all_detector_images_all_channels(star, run_ctx, nuv_channel, vis_channel, nir_channel)
        ...
        nuv_images, vis_images, nir_images = build_science_images(rate_nir, nuv_channel, vis_channel, nir_channel, run_ctx, star)
