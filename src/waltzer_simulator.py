...
def main():
    try:
        ...
        spectra_2d_nuv, spectra_2d_vis, nir_rate_frame = prepare_all_detector_images_all_channels(star, run_ctx, nuv_channel, vis_channel, nir_channel)


        nuv_image, vis_image = build_science_images(spectra_2d_nuv, spectra_2d_vis, nir_rate_frame, nuv_channel, vis_channel, nir_channel, run_ctx, star)
