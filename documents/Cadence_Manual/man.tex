...
\begin{itemize}
    ...
    \item \texttt{data/} — all static data files required by the simulator:
          \begin{itemize}
              ...
              \item \texttt{stellar\_param\_mamjeck.txt} — Mamajek dwarf star parameter table for spectral type assignment
...
All configuration files are located in \texttt{configs/}. Every parameter is documented inline in the respective file.
